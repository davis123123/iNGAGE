...
import ingage.ingage.handlers.ChatRoomHandler;
import ingage.ingage.handlers.SpectateRoomHandler;
...
public class FragmentBase extends Fragment{
    ...
    private void verify(Context context, String type, String thread_id){
        ...
        if(result.equals("thread archived")){
            Toast.makeText(getActivity(), "This discussion has just ended. Feel free to spectate by clicking the Spectate buttonn.", Toast.LENGTH_LONG).show();
            return;
        }
