...
public class ChatFeaturesHandler  extends AsyncTask<String, String, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        String send_token_url ="http://138.68.243.19/send_coin.php";
        String insert_vote_url = "http://138.68.243.19/insert_vote.php";
        String use_coin_url = "http://138.68.243.19/use_coin.php";
