...
public class ChatRoomHandler  extends AsyncTask<String, String, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        String view_url ="http://138.68.243.19/view_chatroom_status.php";
        String join_url ="http://138.68.243.19/join_chatroom.php";
        String leave_url = "http://138.68.243.19/leave_room.php";
        String check_url = "http://138.68.243.19/view_current_room_users.php";
